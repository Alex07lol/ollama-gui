...
export interface Conversation {
  ...
  activePipeline?: CapabilityPipeline | null; // active capability pipeline if intelligent mode is enabled
  pinnedCapabilities?: string[]; // user pinned capabilities
  disabledCapabilities?: string[]; // user disabled capabilities
}
